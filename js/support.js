// ========== SOPORTE TÉCNICO Y TÉRMINOS LEGALES (VERSIÓN MEJORADA) ==========
...
(function() {
    ...
    // 1. Crear botón de WhatsApp (abajo izquierda)
    ...
    // 2. Añadir enlace de términos al footer
    function addTermsLinkToFooter() {
        // Buscar el footer (varias clases posibles)
        ...
        if (!footer) {
            ...
            if (!footer) {
                console.warn('No se encontró el footer para añadir términos');
                // Opcional: crear un footer pequeño al final si no existe
        ...
        // Si el footer tiene párrafos, añadir al primero; si no, añadir directamente
        const firstP = footer.querySelector('p');
        if (firstP) {
            firstP.appendChild(document.createTextNode(' | '));
            firstP.appendChild(link);
        } else {
            // Crear un párrafo con el texto existente más el enlace
        ...
        modal.innerHTML = `
            <div class="modal-content" style="background: white; border-radius: 15px; max-width: 600px; width: 90%; max-height: 90vh; overflow-y: auto; padding: 20px;">
                ...
                <div class="modal-body" style="padding: 10px;">
                    ...
                    <h3>7. Contacto</h3>
                    <p>Para cualquier consulta sobre estos términos, puede contactar a través del botón de WhatsApp disponible en la aplicación.</p>
