...
async function loadSellers() {
    try {
        ...
        displaySellers(sellers, payments);
        updateStats(sellers, payments);
    } catch (error) {
        console.error('Error loading sellers:', error);
        document.getElementById('sellersGrid').innerHTML = `
...
function displaySellers(sellers, payments) {
    ...
    grid.innerHTML = sellers.map(seller => {
        // Obtener pagos/comisiones del gestor
